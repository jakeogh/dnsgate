...
Ee-adding 19 domains in the local blacklist /etc/dnsgate/blacklist to override the whitelist.
...
$ ./dnsgate --install-help
    $ cp -vi /etc/dnsmasq.conf /etc/dnsmasq.conf.bak.1451715153.6291564
